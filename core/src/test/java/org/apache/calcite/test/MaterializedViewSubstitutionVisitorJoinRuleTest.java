...
public class MaterializedViewSubstitutionVisitorJoinRuleTest {
   ...
   */
  @Test public void testJoinOnCalcToJoin000() {
    String mv = ""
   ...
   */
  @Test public void testJoinOnCalcToJoin001() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" left join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
   ...
   */
  @Test public void testJoinOnCalcToJoin002() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" left join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
   ...
   */
  @Test public void testJoinOnCalcToJoin003() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" left join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
   ...
   * apply JoinOnCalcsToJoinUnifyRule.
   */
  @Test public void testJoinOnCalcToJoin004() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" left join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
   ...
   * apply JoinExtendTrivialRule.
   */
  @Test public void testJoinOnCalcToJoin100() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
   ...
   * apply JoinOnLeftCalcToJoinUnifyRule.
   */
  @Test public void testJoinOnCalcToJoin101() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" left join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
   ...
   * apply JoinOnRightCalcToJoinUnifyRule.
   */
  @Test public void testJoinOnCalcToJoin102() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" right join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
   ...
   */
  @Test public void testJoinOnCalcToJoin103() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" right join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  /**
   * apply JoinExtendTrivialRule,
   * As {@link #testJoinOnCalcToJoin100()} but use relation key.
   */
  @Test public void testJoinOnCalcToJoin105() {
    String mv = ""
  ...
  //====================================LEFT TO FULL ====================
  @Test public void testJoinOnCalcToJoin200() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
  ...
  @Test public void testJoinOnCalcToJoin201() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoin202() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoin203() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoin204() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoin300() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoin301() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  //====================================INNER TO FULL ====================
  @Test public void testJoinOnCalcToJoin400() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoi401() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
  ...
  @Test public void testJoinOnCalcToJoin402() {
    String mv = ""
        + "select \"emps\".\"empid\", \"emps\".\"deptno\", \"depts\".\"deptno\" from\n"
        + "\"emps\" full join \"depts\"\n"
        + "on \"emps\".\"deptno\" = \"depts\".\"deptno\"";
