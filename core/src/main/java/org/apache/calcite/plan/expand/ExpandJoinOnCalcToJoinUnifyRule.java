...
import static org.apache.calcite.plan.expand.JoinRexUtils.addJoinDerivePredicate;
...
import static org.apache.calcite.plan.expand.SubstitutionRuleUtils.canPullUpFilterUnderJoin;
import static org.apache.calcite.plan.expand.SubstitutionRuleUtils.fieldCnt;
import static org.apache.calcite.plan.expand.SubstitutionRuleUtils.referenceByMapping;
...
public class ExpandJoinOnCalcToJoinUnifyRule
  ...
  @Override protected SubstitutionVisitor.@Nullable UnifyRuleCall match(SubstitutionVisitor visitor,
  ...
  @Override protected SubstitutionVisitor.@Nullable UnifyResult apply(
    ...
    JoinContext joinContext =
        extractJoinContext(query, target, joinConditionColumnPairs,
    ...
    if (splitted != null && splitted.isAlwaysTrue()) {
      ...
      final RexNode compenCond =
          addJoinDerivePredicate(
              rexBuilder, joinContext, RexUtil.composeConjunction(rexBuilder,
